module.exports = {
  ...
  SUBSCRIPTION_END: {
    CODE: -1, 
    MESSAGE: 'Your subscription was ended. Please contact system administrator',
  }, 
  ORG_INACTIVE: {
    CODE: -2, 
    MESSAGE: 'Your Organization was inactive. Please contact system administration'
  }, 
  ORG_NOT_FOUND: {
    CODE: 59, 
  ...
  USER_LIMIT_REACHED: {
    CODE: -3,
    MESSAGE: 'User limit reached for this organizaton.'
  }, 
  REPORT_NOT_FOUND: {
    CODE: 60, 
