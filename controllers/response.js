...
exports.getAllResponsesByFormId = async (req, res, next) => {
  try {
    ...
    const reportId = await Form.findById(req.params.formId);
...
//   zip.addLocalFile(audioFile[0].path);
...
//   // Save the zip file
//   const zipFilePath = path.join(__dirname, '../audio', zipFilename);
//   zip.writeZip(zipFilePath);
...
// // Create a zip file
// const zipPath = path.join(directoryPath, 'audio.zip');
...
// const saveData = await audioAuditSchema.create({
//   audioAudit: zipPath,
//   audioAuditId: audioAuditId
// });
